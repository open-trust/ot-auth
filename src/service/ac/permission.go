...
const (
	// OTDefault ...
	OTDefault ObjectType = "Default"
	// OTDomain ...
	OTDomain ObjectType = "Domain"
	// OTService ...
	OTService ObjectType = "Service*"
	// OTUser ...
	OTUser ObjectType = "User"
	// OTUserBundle ...
	OTUserBundle ObjectType = "UserBundle"
	// OTPermission ...
	OTPermission ObjectType = "Permission"
)
